...
ENTITLEMENTS_PATH="${ENTITLEMENTS_PATH:-$ROOT_DIR/native-macos/Resources/Entitlements.plist}"
ICON_PATH="${ICON_PATH:-$ROOT_DIR/native-macos/Resources/AppIcon.icns}"
