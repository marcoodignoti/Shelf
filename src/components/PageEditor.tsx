...
function EditorSurface({
  ...
  return (
    <div className="flex flex-col h-full w-full relative" onKeyDown={handleKeyDown}>
      {!isStudioVariant && (
        <div className="h-11 border border-b-0 border-border/70 rounded-t-xl flex items-center justify-between pr-6 pl-36 shrink-0 bg-background/95 backdrop-blur z-40 select-none">
