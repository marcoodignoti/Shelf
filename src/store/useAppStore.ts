...
import { Page, getPages, createPage, createPageFromTemplate, createProject, deletePage, deleteProject, duplicatePage, movePage, reorderPages, toggleFavorite, toggleTemplate, updatePage } from '../lib/db';
...
export interface AppState extends SharedSlice, ProfileSlice, StudioSlice {
  pages: Page[];
